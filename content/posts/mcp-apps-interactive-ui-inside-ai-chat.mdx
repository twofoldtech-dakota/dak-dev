...
Start with the [official docs](https://modelcontextprotocol.io/extensions/apps/overview), clone the [ext-apps repo](https://github.com/modelcontextprotocol/ext-apps), and run any of the 12+ examples to see interactive tool UIs in action.
