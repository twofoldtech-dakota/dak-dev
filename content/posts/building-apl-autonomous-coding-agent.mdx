...
Claude Code changed how I write software. But I wanted more. I wanted Claude to handle entire features autonomously—planning the work, writing the code, testing it, and learning from mistakes. So I built APL: the Autonomous Phased Looper.
...
APL is implemented as a Claude Code plugin—a collection of markdown files defining agents, commands, and hooks.
