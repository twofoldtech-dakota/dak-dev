...
Anthropic published the Agent Skills specification at [agentskills.io](https://agentskills.io/home) in December 2025. The core format matches what Claude Code uses: a directory with a `SKILL.md` file containing YAML frontmatter and markdown instructions.
